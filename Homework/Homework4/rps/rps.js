...
function go()
{
	...
	if(numChoice==0) 
	{
		...
		document.getElementById('lblRock').style.backgroundColor= "pink";
	...
	else if(numChoice==1)
	{
		...
		document.getElementById('lblPaper').style.backgroundColor= "pink";
		if(playerChoice=='rock')
		{
			txtEndTitle.innerHTML="Paper covers Rock";
			txtEndMessage.innerHTML="YOU LOSE";
	...
	else if(numChoice==2) 
	{
		...
		document.getElementById('lblScissors').style.backgroundColor= "pink";
